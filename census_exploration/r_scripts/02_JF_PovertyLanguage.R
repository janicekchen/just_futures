...
for (lang in lang_list) {
  ...
  saveWidget(map, file = paste0("census_exploration/maps/language_2020/", lang, "_acs2019.html"))
...
for (r in race_list) {
  ...
  saveWidget(map, paste0("census_exploration/maps/00_census_october/", race, "_2020.html"))
}
